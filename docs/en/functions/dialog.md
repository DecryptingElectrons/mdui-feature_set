...
The `dialog` function is a wrapper for the [`<mdui-dialog>`](/en/docs/2/components/dialog) component. It provides a convenient way to open a dialog without writing HTML for the component.
