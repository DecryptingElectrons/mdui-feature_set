...
The `getColorFromImage` function extracts the dominant color from an image.

The extracted color can be used together with the [`setColorScheme`](/en/docs/2/functions/setColorScheme) function to implement [dynamic color](/en/docs/2/styles/dynamic-color) functionality.
